...
/**
 * Squelette de chargement de la fiche — CSS pur (`animate-pulse`), affiché
 * par `app/comprendre/[slug]/loading.tsx` pendant le rendu serveur.
 */
export function FicheDetailSkeleton() {
  return (
    <div aria-hidden className="animate-pulse">
      <div className="border-border border-b py-6">
        <Container>
          <div className="bg-secondary h-4 w-64 rounded-full" />
        </Container>
      </div>
