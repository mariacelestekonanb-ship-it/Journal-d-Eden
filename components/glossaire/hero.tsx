...
/**
 * Hero du Glossaire. Même identité visuelle que l'accueil, Comprendre et
 * Veille juridique (illustration orbitale réutilisée), copie propre à cette
 * page.
 */
export function GlossaireHero() {
      ...
      <div className="relative grid items-center gap-16 lg:grid-cols-2 lg:gap-12">
        <div>
          ...
          >
            ...
            >
              Comprenez rapidement les principaux termes du droit spatial et du
              droit du numérique grâce à des définitions claires et accessibles.
            </Paragraph>
          </motion.div>
        </div>
